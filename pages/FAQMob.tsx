        ...
        <div className="container-mob">
          <big className="text-faq-mob">
            <div className="text-mob">
              ...
              <ul className="answer">
                О. Классический массаж направлен на глубокую проработку мышц
                спины и выполняется на массажном столе. Массаж Юмейхо включает в
                себя – (японский) проработку мышц и фасций всего тела,
                мануальную терапию, висцеральный массаж; (вьетнамский) растяжки,
                скрутки, вытягивания, глубокие продавливания. Имеет системный
                подход к восстановлению организма и выполняется на мате.
              </ul>
            </div>
            ...
            <div className="text-mob">
              ...
              <ul className="answer">
                ...
                хорошего результата, курс от 8 до 20 сеансов, с периодичностью
                2-3 раза в неделю. В качестве профилактики, для поддержания тела
                в хорошем самочувствии, достаточно 1 раз в неделю.
              </ul>
            </div>
            ...
            <div className="text-mob">
              ...
              <ul className="answer">
                О. Если вы проходите массаж Юмейхо курсами, то их можно
                повторять каждые полгода или год.
              </ul>
            </div>
            ...
            <div className="text-mob">
              <ul className="question">
                В. Когда появятся результаты массажа?
              </ul>
              <ul className="answer">
                О. Ощутимые результаты вы получите после нескольких сеансов
                массажа, однако с большой вероятностью, вы почувствуете
                результат уже после первого сеанса, вы ощутите прилив энергии,
                расслабление, уменьшение или полное исчезновение боли.
              </ul>
            </div>
