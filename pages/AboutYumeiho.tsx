    ...
    <>
      <div className="about-yumeiho-container">
        ...
        <div className="first-section">
          ...
          <div className="text">
            <big>
              Юмейхо терапия с японского языка, переводится как -
              "восстановление жизненных сил", эта система имеет холистический
              (целостный) подход к восстановлению организма человека. Под
              понятием "жизненные силы" подразумевается, что при коррекции
              костей таза, позвоночника, конечностей и гипертонуса мышц,
              полноценно восстанавливается движение крови, лимфы, иннервация
              (нервная связь), энергетика человека. Сама терапия была создана
              профессором Масаюки Сайонджи, японским врачом-эсперантистом в 1978
              году и на момент 2004 года, уже была признана и широко
              распространена в 73 странах мира. В основе Юмейхо терапии лежат
              древние техники восстановления физиологии путем равновесия и
              баланса, работы с фасциями, мио-суставной функциональной
              коррекции, акупрессуры, мануальной терапии, висцеральной
              хиропрактики, гимнастики.
            </big>
          </div>
        </div>
